 ...
 *	More sophisticated AI: The AI will automatically adjust the difficulty according to
 *	the scores between the player and AI itself. If the player scores more, the AI will get
 *	more difficult to defeat. Wise versa.
